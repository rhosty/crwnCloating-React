...
import Button from '../button/button.comp';
import Bin from '../bin/bin.comp';
import ItemsContainer from '../items-container/itemContainer.comp';
import './dropdown.style.scss';
import { ItemQuantityContext } from '../../contexts/itemQantity.ctx';
    ...
    <Fragment>
      {cartInfo.length ? (
        <div className='container'>
          <div className='cart-dropdown-container'>
            <h2>Shopping Cart</h2>
            <ItemsContainer filteredCartInfo={filteredCartInfo} quantity={quantity} updateQuantity={updateQuantity} />
            <Link to='/checkout'>
              <Button buttonType='inverted'>Checkout</Button>
            </Link>
          </div>
